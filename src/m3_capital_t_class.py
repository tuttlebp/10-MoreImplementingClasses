    ...
    *** See the PDFs, especially dimensions.pdf, to help you understand this.
    ...
    def __init__(self, intersection_center, width, height, letter_thickness):
        ...
        *** See   dimensions.pdf   to understand the following! ***
        ...
        # ---------------------------------------------------------------------
        start_h_point = rg.Point(intersection_center.x - width / 2, intersection_center.y - letter_thickness / 2)
        end_h_point = rg.Point(intersection_center.x + width / 2, intersection_center.y + letter_thickness / 2)
        h_rect = rg.Rectangle(start_h_point, end_h_point)
        start_v_point = rg.Point(intersection_center.x - letter_thickness / 2,
                                 intersection_center.y - letter_thickness / 2)
        end_v_point = rg.Point(intersection_center.x + letter_thickness / 2,
                               intersection_center.y + height - letter_thickness / 2)
        v_rect = rg.Rectangle(start_v_point, end_v_point)
        self.h_rect = h_rect
        self.v_rect = v_rect
    ...
    def set_colors(self, fill_color, outline_color):
        ...
        self.h_rect.fill_color = self.v_rect.fill_color

        self.v_rect.outline_color = outline_color
        self.h_rect.outline_color = self.v_rect.outline_color
    ...
    def clone(self):
        ...
        the_t.h_rect.outline_color = self.h_rect.outline_color
